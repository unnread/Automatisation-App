...
int main(int argc, char* argv[])
{
    ...
    window.setWindowTitle("Assistant Windows");
...
{
    QString path = qEnvironmentVariable("LOCALAPPDATA")
    ...
    {
        QProcess::startDetached("firefox.exe");
    });

    // Footer
    QLabel footer("Windows Version", &window);
